...
inline SimpleGraph example_graph{ {
    { 'A',{ 'B' } },
    { 'B',{ 'A', 'C', 'D' } },
    { 'C',{ 'A' } },
    { 'D',{ 'E', 'A' } },
...
inline std::array<GridLocation, 4> SquareGrid::DIRS = { GridLocation{ 1, 0 }, GridLocation{ 0, -1 }, GridLocation{ -1, 0 }, GridLocation{ 0, 1 } };
...
inline std::vector<Location> reconstruct_path(
